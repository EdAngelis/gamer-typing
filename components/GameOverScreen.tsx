  ...
  return (
    <div className="max-w-md w-full bg-slate-800 border border-slate-700 rounded-3xl p-8 shadow-2xl animate-in zoom-in-95 duration-300">
      <div className="text-center mb-8">
        ...
        <p className={`text-lg font-medium ${rank.color}`}>Rank: {rank.label}</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-slate-900/50 p-4 rounded-2xl flex flex-col items-center justify-center border border-slate-700/50">
          ...
          <span className={`text-3xl font-bold font-mono ${accuracy >= 90 ? 'text-green-400' : accuracy >= 70 ? 'text-yellow-400' : 'text-red-400'}`}>
            {accuracy}%
          </span>
        </div>
        ...
        <div className="bg-slate-900/50 p-4 rounded-2xl flex flex-col items-center justify-center border border-slate-700/50">
            <div className="flex items-center space-x-2 text-slate-400 mb-1 text-sm">
                <div className="w-4 h-4 font-mono font-bold flex items-center justify-center border border-slate-600 rounded text-[10px]">K</div>
                <span>Correct</span>
            </div>
